...
from models.inventory import calculate_safety_stock, calculate_reorder_point, classify_stock_status
...
tab1, tab2, tab3, tab4 = st.tabs(["📊 Overview", "🤖 Forecast Model", "🧠 Inventory Decision", "📁 Results Export"])
